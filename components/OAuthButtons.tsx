    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex gap-3">
        <motion.button
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-white/40 bg-white/70 px-3 py-2 text-sm font-medium text-slate-700 shadow-sm backdrop-blur-xl dark:border-white/10 dark:bg-slate-800/90 dark:text-slate-200"
        >
