...
const VARIANT_CLASS: Record<ButtonVariant, string> = {
  primary:
    "relative h-[42px] overflow-clip rounded-lg border border-solid border-white/20 bg-gradient-to-r from-amber-500 via-orange-500 to-rose-500 px-5 text-[14px] font-medium tracking-[-0.28px] text-white shadow-[0px_2px_6px_0px_rgba(249,115,22,0.35)] before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:shadow-[inset_0px_4px_4px_0px_rgba(255,255,255,0.25)] ipad:h-[55px] ipad:rounded-[11px] ipad:px-[27px] ipad:text-[18px] ipad:tracking-[-0.36px] desktop-sm:h-10 desktop-sm:rounded-lg desktop-sm:px-5 desktop-sm:text-[14px] desktop-sm:tracking-[-0.28px]",
  secondary:
    "h-[42px] rounded-lg border border-solid border-slate-300 bg-transparent px-4 py-3 text-[14px] font-medium tracking-[-0.28px] text-slate-700 transition-[border-color,opacity,transform] duration-200 ease ipad:h-[55px] ipad:rounded-[11px] ipad:px-[22px] ipad:py-0 ipad:text-[18px] ipad:tracking-[-0.36px] desktop-sm:h-10 desktop-sm:rounded-lg desktop-sm:px-4 desktop-sm:py-3 desktop-sm:text-[14px] desktop-sm:tracking-[-0.28px] [@media(hover:hover)_and_(pointer:fine)]:hover:border-amber-500 [@media(hover:hover)_and_(pointer:fine)]:hover:opacity-100",
