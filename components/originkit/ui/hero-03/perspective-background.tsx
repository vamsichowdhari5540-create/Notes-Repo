...
export const PerspectiveBackground = () => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(250,250,249,0.55)_0%,rgba(250,250,249,0.22)_40%,transparent_64%)] ipad:bg-[radial-gradient(ellipse_at_center,rgba(250,250,249,0.62)_0%,rgba(250,250,249,0.3)_38%,transparent_62%)] desktop-sm:bg-[radial-gradient(ellipse_at_center,rgba(250,250,249,0.72)_0%,rgba(250,250,249,0.38)_36%,transparent_60%)]" />
    </div>
  );
};
